    ...
    <>
      <div className="mb-4">
        ...
        <span className="text-sm  text-gray-700 dark:text-gray-400">
          Edit the bot credentials to update the existing bot settings. You can
          modify bot credentials as needed.
        </span>
      </div>
          ...
          >
            ...
            {totalBusinesses.map((business, index) => {
              if (attachedBusiness === business.businessName) {
                return (
                  <>
                    <option key={index} value={business.businessName} selected>
